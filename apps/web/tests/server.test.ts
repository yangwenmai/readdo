...
test("web root serves inbox html shell", async () => {
  await withServer(async (baseUrl) => {
    ...
    assert.match(text, /title="Shortcuts: \/ Search · H Toggle Shortcut Guide · J Select next item · K Select previous item · F Focus Mode · A Advanced Panels · P Focus Priority · Shift\+P Focus Priority \(reverse\) · G Edit Context Filters · N Focus Recommended Item · M Run Primary Item Action · O Open Selected Source · Y Copy Selected Source · I Copy Selected Context · Shift\+G Clear Step Focus · Esc Clear Step Focus · 1 Focus extract step · 2 Focus pipeline step · 3 Focus export step · 0 Focus unknown step · Alt\+1 Focus Priority Smart · Alt\+2 Focus Priority Query First · Alt\+3 Focus Priority Step First · \[ Previous Recovery Run · \] Next Recovery Run · L Latest Recovery Run · C Clear Filters · Shift\+C Reset Controls · T Toggle Auto Refresh · W Run Worker Once · R Refresh · \? Show shortcuts"/u);
    assert.match(text, /aria-label="Shortcuts: \/ Search · H Toggle Shortcut Guide · J Select next item · K Select previous item · F Focus Mode · A Advanced Panels · P Focus Priority · Shift\+P Focus Priority \(reverse\) · G Edit Context Filters · N Focus Recommended Item · M Run Primary Item Action · O Open Selected Source · Y Copy Selected Source · I Copy Selected Context · Shift\+G Clear Step Focus · Esc Clear Step Focus · 1 Focus extract step · 2 Focus pipeline step · 3 Focus export step · 0 Focus unknown step · Alt\+1 Focus Priority Smart · Alt\+2 Focus Priority Query First · Alt\+3 Focus Priority Step First · \[ Previous Recovery Run · \] Next Recovery Run · L Latest Recovery Run · C Clear Filters · Shift\+C Reset Controls · T Toggle Auto Refresh · W Run Worker Once · R Refresh · \? Show shortcuts"/u);
    assert.match(text, /Shortcuts: \/ Search · H Toggle Shortcut Guide · J Select next item · K Select previous item · F Focus Mode · A Advanced Panels · P Focus Priority · Shift\+P Focus Priority \(reverse\) · G Edit Context Filters · N Focus Recommended Item · M Run Primary Item Action · O Open Selected Source · Y Copy Selected Source · I Copy Selected Context · Shift\+G Clear Step Focus · Esc Clear Step Focus · 1 Focus extract step · 2 Focus pipeline step · 3 Focus export step · 0 Focus unknown step · Alt\+1 Focus Priority Smart · Alt\+2 Focus Priority Query First · Alt\+3 Focus Priority Step First · \[ Previous Recovery Run · \] Next Recovery Run · L Latest Recovery Run · C Clear Filters · Shift\+C Reset Controls · T Toggle Auto Refresh · W Run Worker Once · R Refresh · \? Show shortcuts/u);
