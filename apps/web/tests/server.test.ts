...
test("web root serves inbox html shell", async () => {
  await withServer(async (baseUrl) => {
    ...
    assert.match(text, /title="Shortcuts: \/ Search · F Focus Mode · A Advanced Panels · P Focus Priority · R Refresh · \? Show shortcuts"/u);
    assert.match(text, /aria-label="Shortcuts: \/ Search · F Focus Mode · A Advanced Panels · P Focus Priority · R Refresh · \? Show shortcuts"/u);
    assert.match(text, /Shortcuts: \/ Search · F Focus Mode · A Advanced Panels · P Focus Priority · R Refresh · \? Show shortcuts/u);
